...
<div class="container">
	...
	<form action="incluir_cargo.php" method="post">
		<fieldset>
  			...
  			<table class="table table-hover">
  				...
  				?>	
    				<tr>
    					...
    					<td class="col-md-1"><?php echo $objetoCargo->getNome(); ?></td>
    					<td class="col-md-3"><?php echo $objetoCargo->getDescricao(); ?></td>
    					<td class="col-md-1"><?php echo "R$ ".$objetoCargo->getSalarioBase(); ?></td>
    					<td class="col-md-1">
    						<a class="btn btn-danger" href="excluir_cargo.php?codigo=<?= $objetoCargo->getCodigo(); ?>" role="button">Excluir</a>  								
    					</td>
    				</tr>
    			<?php
					}
